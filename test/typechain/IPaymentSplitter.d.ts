...
interface IPaymentSplitterInterface extends ethers.utils.Interface {
  functions: {
...
export class IPaymentSplitter extends BaseContract {
  ...
  functions: {
    ...
    payees(index: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
  ...
  totalReleased(account: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  estimateGas: {
    ...
    payees(index: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
