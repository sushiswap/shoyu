...
interface NFTStaticCallProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTStaticCallProxy extends BaseContract {
  ...
  interface: NFTStaticCallProxyInterface;
