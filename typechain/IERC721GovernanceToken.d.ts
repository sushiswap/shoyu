...
interface IERC721GovernanceTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IERC721GovernanceToken extends Contract {
  ...
  interface: IERC721GovernanceTokenInterface;
  ...
  totalPowerOf(id: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
