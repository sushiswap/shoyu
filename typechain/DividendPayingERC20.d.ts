...
interface DividendPayingERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class DividendPayingERC20 extends BaseContract {
  ...
  interface: DividendPayingERC20Interface;
