...
interface IPaymentSplitterFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IPaymentSplitterFactory extends BaseContract {
  ...
  interface: IPaymentSplitterFactoryInterface;
