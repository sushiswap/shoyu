...
interface SocialTokenV0Interface extends ethers.utils.Interface {
  functions: {
...
export class SocialTokenV0 extends BaseContract {
  ...
  interface: SocialTokenV0Interface;
